...
from biz2bricks_core.db.config import db_config
    ...
    async def _create_cloud_sql_engine_async(self) -> Tuple[AsyncEngine, Any]:
        ...
        try:
            ...
            logger.info(
                ...
                f"instance={db_config.CLOUD_SQL_INSTANCE}, "
                f"ip_type={db_config.CLOUD_SQL_IP_TYPE}, "
                f"user={db_config.DATABASE_USER}, "
